...
Este exemplo é modificado para hooks a partir de um exemplo anterior no [Guia Avanção de Contexto](/docs/context.html), onde você pode encontrar mais informações sobre quando e como usar o Context.
